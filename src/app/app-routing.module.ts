...
const routes: Routes = [
  ...
  { path: 'course', component: CourseAddComponent,canActivate :[authGuard], data: {roles:['admin','teacher']} },
  { path: 'course/:name', component: CourseAddComponent,canActivate :[authGuard], data: {roles:['admin','teacher']} },
  ...
  { path: 'course-add/:id', component: CourseAddComponent,canActivate :[authGuard], data: {roles:['admin','teacher']} },
  { path: 'course-details/:id', component: CourseDetailsComponent,canActivate :[authGuard], data: {roles:['admin','teacher']}},
